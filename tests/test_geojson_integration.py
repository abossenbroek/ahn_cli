...
class TestGeoJSONIntegration(unittest.TestCase):
    ...
    @patch('ahn_cli.manipulator.ptc_handler.PntCHandler.clip_by_arbitrary_polygon')
    @patch('ahn_cli.fetcher.request.Fetcher.fetch')
    @patch('ahn_cli.fetcher.geotiles.ahn_subunit_indices_of_geojson')
    def test_geojson_pipeline_basic(self, mock_indices, mock_fetch, mock_clip):
    ...
    @patch('ahn_cli.fetcher.request.Fetcher.fetch')
    @patch('ahn_cli.fetcher.geotiles.ahn_subunit_indices_of_geojson')
    def test_geojson_with_class_filtering(self, mock_indices, mock_fetch, mock_clip):
    ...
    @patch('ahn_cli.fetcher.request.Fetcher.fetch')
    @patch('ahn_cli.fetcher.geotiles.ahn_subunit_indices_of_geojson')
    def test_geojson_with_verification(self, mock_indices, mock_fetch, mock_clip):
    ...
    def test_geojson_many_tiles_warning(self, mock_indices, mock_warning):
        ...
        fetcher = Fetcher("http://test.com/", geojson_file=self.geojson_path)
