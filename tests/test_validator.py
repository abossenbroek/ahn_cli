...
class TestValidator:
    ...
    def test_validate_geojson_file_not_exists(self):
        ...
        with pytest.raises(ClickException, match="GeoJSON file does not exist"):
    ...
    def test_validate_geojson_invalid_extension(self, tmp_path):
        ...
        with pytest.raises(ClickException, match="File must have .geojson or .json extension"):
    ...
    def test_validate_exclusive_args_no_options(self):
        ...
        with pytest.raises(ClickException, match="You must specify exactly one of"):
